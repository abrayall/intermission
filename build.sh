...
# Intermission Build Script
# Packages the Intermission plugin as a WordPress-ready ZIP file
...
# Intermission Version Information
...
# Build Intermission Plugin
echo -e "${BLUE}Building Intermission plugin...${NC}"
PLUGIN_DIR="$BUILD_DIR/intermission"
mkdir -p "$PLUGIN_DIR"

# Copy plugin files
cp intermission.php "$PLUGIN_DIR/"
...
# Create ZIP
cd "$BUILD_DIR"
zip -r "intermission-${VERSION}.zip" intermission/ -q
echo -e "${GREEN}✓ Created: intermission-${VERSION}.zip${NC}"

# Clean up temporary directory
cd "$SCRIPT_DIR"
rm -rf "$BUILD_DIR/intermission"
